				...
				<div class="thankyou-view">
					<div class="thankyou_01">
						...
						<div class="text-center">
							<h1 class="result">
								You have completed the AIMS Pitch Discrimination exercise. You correctly answered <span class="score"><?=$CorrectAns;?></span> of the <span class="score"><?=$NoOfQtsAttempted;?></span> items.
							</h1>
							<h2 class="color-white result">
								This indicates that you have <span class="color:"><?=$Grade;?></span> Pitch Discrimination ability. 
							</h2>
						</div>
					</div>
